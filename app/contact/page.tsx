    ...
    return (
        <div className="relative bg-slate-950 overflow-hidden min-h-screen">
            ...
            <div className="relative z-10">
                ...
                <div className="px-4 sm:px-6 lg:px-8 mb-20">
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-white mb-4">{content.responseTime.title}</h2>
                            <p className="text-slate-400">{content.responseTime.subtitle}</p>
                        </div>
                ...
                {/* Main Contact Component (already localized internally) */}
                <Contact />
                ...
                <div className="px-4 sm:px-6 lg:px-8 py-20 border-t border-slate-800/50">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-white mb-4">{content.whyMe.title}</h2>
                            <p className="text-slate-400">{content.whyMe.subtitle}</p>
                        </div>
                            ...
                            {content.whyMe.items.map((item, index) => {
                                ...
                                return (
                                    <div
                                        ...
                                        style={{ animationDelay: `${index * 0.1}s` }}
                                    >
                                        <Icon className="text-3xl text-green-400 mb-4 group-hover:scale-110 transition-transform" />
                ...
                <div className="px-4 sm:px-6 lg:px-8 py-20 border-t border-slate-800/50">
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">{content.faq.title}</h2>
                            <p className="text-slate-400">{content.faq.subtitle}</p>
                        </div>
