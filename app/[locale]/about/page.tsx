...
export default function AboutPage() {
    ...
    const projectsCount = getProjects(locale as any).length.toString();
    ...
    const timelineItems = t.raw('timeline.items') as any[];
    const approachItems = t.raw('approach.items') as any[];
    const educationItems = t.raw('personal.education.items') as any[];
    const languageItems = t.raw('personal.languages.items') as any[];
    const interestItems = t.raw('personal.interests.items') as any[];
    const quoteEmojis = t.raw('quote.emojis') as any[];
                ...
                <div className="px-4 sm:px-6 lg:px-8 py-20">
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">{t('timeline.title')}</h2>
                            <p className="text-slate-600 dark:text-slate-400">{t('timeline.subtitle')}</p>
                        </div>
                ...
                <div className="px-4 sm:px-6 lg:px-8 py-20 border-t border-slate-200 dark:border-slate-800/50">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">{t('approach.title')}</h2>
                            <p className="text-slate-600 dark:text-slate-400">{t('approach.subtitle')}</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                            ...
                            <div className="group bg-white dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700/50 p-8 rounded-2xl animate-fade-in-up hover:scale-105 transition-all duration-300">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">{t('personal.education.title')}</h3>
                                </div>
                            ...
                            <div className="group bg-white dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700/50 p-8 rounded-2xl animate-fade-in-up hover:scale-105 transition-all duration-300" style={{ animationDelay: '0.1s' }}>
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">{t('personal.languages.title')}</h3>
                                </div>
                            ...
                            <div className="group bg-white dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700/50 p-8 rounded-2xl animate-fade-in-up hover:scale-105 transition-all duration-300" style={{ animationDelay: '0.2s' }}>
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">{t('personal.interests.title')}</h3>
                                </div>
                                <div className="space-y-4">
