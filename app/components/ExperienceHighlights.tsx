                            ...
                            >
                                ...
                                <div className="hidden md:block absolute top-8 left-1/2 transform -translate-x-1/2 md:left-auto md:translate-x-0" style={{
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="relative w-4 h-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full border-4 border-slate-950" />
                                    </div>
                                </div>
                                ...
                                <div className="group relative">
                                    ...
                                    {/* Card Content */}
                                    <div className="relative bg-slate-800/50 backdrop-blur-sm border-2 border-slate-700/50 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 shadow-lg hover:shadow-2xl">
                                        {/* Header */}
                                        <div className="mb-6">
                                            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-3">
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-2 text-purple-400 font-semibold text-lg mb-2">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {exp.skills.map((skill, skillIndex) => (
                                                <span
                                                    key={skillIndex}
                                                    className="px-4 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 text-blue-300 rounded-lg text-sm font-medium hover:scale-105 transition-transform cursor-default"
                                                >
                                                    {skill}
                                                </span>
                                            ))}
