export const aboutPageContent = {
    ...
    stats: [
        ...
        { iconName: "FaCode", label: "Projects Completed", value: "9+", color: "green" }, // Value handled dynamically ideally, but hardcoding provided value format in list is okay if consistent
